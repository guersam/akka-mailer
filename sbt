...
# Set/Get the sbt build properties (version)
build_props_sbt () {
...
declare -r cms_opts="-XX:+CMSParallelRemarkEnabled -XX:+CMSClassUnloadingEnabled -XX:+UseConcMarkSweepGC"
declare -r jit_opts="-XX:ReservedCodeCacheSize=256m -XX:+TieredCompilation"
declare -r default_jvm_opts="-Dfile.encoding=UTF8 -XX:MaxPermSize=1024m -Xms512m -Xmx1536m -Xss8m -XX:+AggressiveOpts -XX:+UseParNewGC -XX:SurvivorRatio=128 -XX:MaxTenuringThreshold=0 $jit_opts $cms_opts"
...
declare -a extra_jvm_opts
declare -a extra_sbt_opts
